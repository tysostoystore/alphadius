...
async function main() {
    ...
    for (const [userId, { user, topTrack }] of artists) {
        ...
        const snapshot: ArtistSnapshot = {
            ...
            totalPlays: topTrack.play_count || 0,
            topTrackId: topTrack.permalink || topTrack.id || "unknown",
            topTrackTitle: topTrack.title || "Unknown Track",
            topTrackPlays: topTrack.play_count || 0,
