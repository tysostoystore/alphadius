...
export function AboutModal({ isOpen, onClose }: AboutModalProps) {
    ...
    useEffect(() => {
        ...
        async function fetchCreatorStats() {
            try {
                // Fetch user data via Specific ID
                ...
                // Fetch top track to mimic the ingest database signal
                ...
                // Calculate Alpha — 3-Pillar Formula
                // Alpha = Engagement × Momentum × Gravity
                const engagement = Math.sqrt(topTrackPlays / (followers + 100));
                const velocity = Math.floor(topTrackPlays * 0.05); // cold-start estimate
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-lg bg-[#0A0510] border border-zinc-800 rounded-xl shadow-2xl p-6 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                {/* Glow effect */}
                ...
                <div className="space-y-6 relative text-sm text-zinc-300 font-sans leading-relaxed">
